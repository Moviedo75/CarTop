<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="Cartera.view.InicioLogin" %>
<!DOCTYPE html>
    ...
    <form runat="server">
        <div id="page-wrapper">
            ...
            <header id="header" class="alt">
                ...
                <nav id="nav">
                    <ul>
                        <li><a href="login.aspx" class="button">Iniciar Sesion</a></li>
                    </ul>
                </nav>
            </header>
            ...
            <section id="banner">
                <h2>Cartop</h2>
                <p>
                    Lo Mejor Para Optimizar La Creacion De Carteras <br/>
                    y Proteger Sus Datos.
                </p>
                <ul class="actions">
                    <li><a href="Login.aspx" class="button special">Inicia Sesion</a></li>
                    <li><a href="Registro.aspx" class="button special">Registrate</a></li>
                </ul>
            </section>
            ...
            <section id="main" class="container">
                ...
                <section class="box special">
                    ...
                    <span class="image featured"><img src="../images/logoCartografia.jpg" alt="" /></span>
                </section>
            ...
            <footer id="footer">
                ...
                <ul class="copyright">
                    ...
                    <li>Aplicacion diseñada por: <a href="inicio.aspx">Cartop</a></li>
                </ul>
            </footer>
